-- Expose badge kind on feed rows so clients can skip dedicated glitter for model_glb.
...
as $$
  with activity as (
    select
      ...
      a.icon_url,
      a.icon_file_id,
      coalesce(a.icon_asset_kind, 'image') as icon_asset_kind,
      a.tone,
      a.achieved_at,
      a.created_at,
      a.updated_at,
