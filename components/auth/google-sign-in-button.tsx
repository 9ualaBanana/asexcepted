...
export function GoogleSignInButton({ next }: GoogleSignInButtonProps) {
  ...
  useErrorToast(error, { id: "google-sign-in" });
  ...
  return (
    <button
      ...
      className="flex h-10 w-full items-center justify-center gap-3 rounded-md bg-[#131314] px-3 text-sm font-medium text-[#e3e3e3] transition-opacity hover:opacity-90 disabled:pointer-events-none disabled:opacity-50"
    >
      <GoogleGLogo />
      <span>
